...
+ (NSUInteger) queryField: (NSString *) header message: (NSString *) text out1: (NSString **) out1 secure: (bool) secure  isSwitch: (bool) isSwitch savePassword:(bool *) savePassword; 
...
+ (NSUInteger) queryWithFields: (NSString *)header message: (NSString *)text button1: (NSString *)button1
                                          button2: (NSString *)button2 out1: (NSString **) out1 secure: (bool) secure
                                          isSwitch: (bool) isSwitch savePassword:(bool *) savePassword;
