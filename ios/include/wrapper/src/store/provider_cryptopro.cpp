...
::TrustedHandle<PkiItem> ProviderCryptopro::objectToPKIItem(::TrustedHandle<Certificate> cert){
	LOGGER_FN();
...
::TrustedHandle<PkiItem> ProviderCryptopro::objectToPKIItem(::TrustedHandle<CRL> crl){
	LOGGER_FN();
...
::TrustedHandle<Certificate> ProviderCryptopro::getCert(::TrustedHandle<std::string> hash, ::TrustedHandle<std::string> category){
	LOGGER_FN();
...
::TrustedHandle<CRL> ProviderCryptopro::getCRL(::TrustedHandle<std::string> hash, ::TrustedHandle<std::string> category){
	LOGGER_FN();
...
::TrustedHandle<Key> ProviderCryptopro::getKey(::TrustedHandle<Certificate> cert) {
	LOGGER_FN();
...
void ProviderCryptopro::addPkiObject(::TrustedHandle<Certificate> cert, ::TrustedHandle<std::string> category){
	LOGGER_FN();
...
void ProviderCryptopro::deletePkiObject(::TrustedHandle<Certificate> cert, ::TrustedHandle<std::string> category){
	LOGGER_FN();
...
bool ProviderCryptopro::hasPrivateKey(::TrustedHandle<Certificate> cert) {
	LOGGER_FN();
