...
#include "../../include/wrapper/pki/oid.h"
...
::TrustedHandle<std::string> OID::toString() {
	LOGGER_FN();
...
::TrustedHandle<std::string> OID::getLongName(){
	LOGGER_FN();
...
::TrustedHandle<std::string> OID::getShortName(){
	LOGGER_FN();
...
::TrustedHandle<std::string> OID::getValue(){
	LOGGER_FN();
