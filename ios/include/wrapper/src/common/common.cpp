#include "../stdafx.h"
#include "../../include/wrapper/common/common.h"

#include <openssl/err.h>
#include <openssl/asn1.h>
#include <openssl/x509.h>

#include "../../include/wrapper/common/refcount.h"
#include "../../include/wrapper/common/excep.h"
#include "../../include/wrapper/common/bio.h"
#include "../../include/wrapper/common/object.h"

::TrustedHandle<std::string> ASN1_TIME_toString(ASN1_TIME* time){
	if (time == NULL)
