...
#include "../../include/wrapper/cms/cmsRecipientInfo.h"
...
::TrustedHandle<std::string> CmsRecipientInfo::getIssuerName() {
	LOGGER_FN();
...
::TrustedHandle<std::string> CmsRecipientInfo::getSerialNumber() {
	LOGGER_FN();
...
int CmsRecipientInfo::ktriCertCmp(::TrustedHandle<Certificate> cert){
	LOGGER_FN();
