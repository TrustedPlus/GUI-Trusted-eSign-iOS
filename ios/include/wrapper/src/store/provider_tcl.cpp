#include "../stdafx.h"
#include "../../include/provider_tcl.h"
...
void ProviderTCL::readTCLfile(const char file_path, CERT_STORE* cert_store, TCL_CURRENT_INFO* tcl_infos){
	...
	//��������� ������ TCL �����
	//-----------------------------------------------------------------------------------------------------------------
	char _version_token_start[15] = { 60, -48, -110, -48, -75, -47, -128, -47, -127, -48, -72, -47, -113, 62, '\0' }; //<������>
	char _version_token_end[16] = { 60, 47, -48, -110, -48, -75, -47, -128, -47, -127, -48, -72, -47, -113, 62, '\0' }; //</������>
	string version_token_start(_version_token_start);
	string version_token_end(_version_token_end);
	char _data_token_start[11] = { 60, -48, -108, -48, -80, -47, -126, -48, -80, 62, '\0' }; //<����>
	char _data_token_end[12] = { 60, 47, -48, -108, -48, -80, -47, -126, -48, -80, 62, '\0' }; //</����>
	string data_token_start(_data_token_start);
	string data_token_end(_data_token_end);
	char _x509_token_start[15] = { 60, -48, -108, -48, -80, -48, -67, -48, -67, -47, -117, -48, -75, 62, '\0' }; //<������>
	char _x509_token_end[16] = { 60, 47, -48, -108, -48, -80, -48, -67, -48, -67, -47, -117, -48, -75, 62, '\0' }; //</������>
