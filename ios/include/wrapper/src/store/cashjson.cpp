...
#include "../../include/wrapper/store/cashjson.h"

CashJson::CashJson(::TrustedHandle<std::string> fileName){
	LOGGER_FN();
...
::TrustedHandle<PkiItemCollection> CashJson::exportJson(){
	LOGGER_FN();

	try{
		::TrustedHandle<PkiItemCollection> items = new PkiItemCollection();
