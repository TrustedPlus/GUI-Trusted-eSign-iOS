 ...
 * OID алгоритма подписи по умолчанию и OID алгоритма хеша 
 * по умолчанию для заданного OID-а алгоритма ключа.
 *
 * Если провайдер поддерживает несколько алгоритмов хеша,
 * совместимых с алгоритмом ключа, выбирается алгоритм
 * хеша GR3411. Если GR3411 несовместим с алгоритмом ключа,
 * выбирается SHA1. Если SHA1 несовместим, выбирается первый
 * алгоритм хеша, который совместим с алгоритмом ключа.
 *
 ...
 * szOID_CP_DH_EL) не будет найден алгоритм подписи/хеша, в силу
