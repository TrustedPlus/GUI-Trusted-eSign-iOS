...
//------------------------------
// Макросы для конвертации строк, полученных из консоли, или перед выводом строк на консоль
#ifdef UNIX
...
//------------------------------
// Макросы для конвертации строк во внутреннее представление провайдера и обратно
...
#define SRC_TIMEOUT (10)	// Реальное обращение не реже, чем раз в 10 сек.
