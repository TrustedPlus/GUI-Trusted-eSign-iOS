 ...
 * //-------------------------------------------------------
 * #define CERT_SET_KEY_PROV_::TrustedHandle_PROP_ID	0x00000001
...
#define PP_::TrustedHandle_COUNT 163
...
/* �����, ������������ � GetProvParam ��� ��������� �������� � ������������� ������ �������.*/
#define CRYPT_CUR_::TrustedHandleS 0
#define CRYPT_MAX_::TrustedHandleS 1
...
typedef union _CRYPT_PIN_SOURCE {
    char *passwd; /*!< ������, PIN-���, ��� ����������. */
    DWORD prov; /*!< 32-������ ���������� ������������� ����������. */
    CRYPT_PIN_NK_PARAM nk_::TrustedHandles; /*!< �������� �� NK �� ��������������� */
} CRYPT_PIN_SOURCE;
 ...
 *  CRYPT_PIN_ENCRYPTION - ::TrustedHandle ���������� ������������.
 *  CRYPT_PIN_QUERY - ��� � �������� ���������� � ����,
 *  CRYPT_PIN_CLEAR - �������� ������.
 *  CRYPT_PIN_NK - ������� �� ����� k �� n
 */
 ...
 * <tr><td>PP_DRVCONTAINER </td><td>�������� ��������� (::TrustedHandle) ���������� � ��������</td></tr>
